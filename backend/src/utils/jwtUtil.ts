...
export const generateAccessToken = (userId:string,role:"admin" | "user" | "doctor")=>{ //payload (userId, role)
...
export const generateRefreshToken = (userId:string,role:"admin" | "user" | "doctor")=>{
